function varargout = gui_SCoBi_ML(varargin)
% GUI_SCOBI_ML MATLAB code for gui_SCoBi_ML.fig
%      GUI_SCOBI_ML, by itself, creates a new GUI_SCOBI_ML or raises the existing
%      singleton*.
%
%      H = GUI_SCOBI_ML returns the handle to a new GUI_SCOBI_ML or the handle to
%      the existing singleton*.
%
%      GUI_SCOBI_ML('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_SCOBI_ML.M with the given input arguments.
%
%      GUI_SCOBI_ML('Property','Value',...) creates a new GUI_SCOBI_ML or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before gui_SCoBi_ML_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to gui_SCoBi_ML_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help gui_SCoBi_ML

% Last Modified by GUIDE v2.5 26-Jul-2018 18:20:15

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @gui_SCoBi_ML_OpeningFcn, ...
                   'gui_OutputFcn',  @gui_SCoBi_ML_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before gui_SCoBi_ML is made visible.
function gui_SCoBi_ML_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to gui_SCoBi_ML (see VARARGIN)

% % Choose default command line output for gui_SCoBi_ML
% handles.output = hObject;
% 
% % Update handles structure
% guidata(hObject, handles);

clearvars -global guiSCoBiMLManager
global guiSCoBiMLManager
guiSCoBiMLManager = gui_SCoBi_ML_Manager(handles);
...
function varargout = gui_SCoBi_ML_OutputFcn(hObject, eventdata, handles) 
...
varargout = guiSCoBiMLManager.outputFun();
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.popup_sim_mode );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.edit_sim_name );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.edit_campaign );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.edit_campaign_date );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.edit_plot );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.popup_veg_method );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.popup_veg_vir_orientations );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.popup_gnd_cover );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.cb_write_attenuation );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.cb_calc_direct_term );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.cb_calc_specular_term );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.cb_calc_diffuse_term );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.edit_veg_plant );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.edit_Nr );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.edit_Nfz );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.edit_f_MHz );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.edit_r_Tx_km );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.edit_EIRP_dB );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.popup_pol_Tx );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.edit_hr_m );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.edit_G0r_dB );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.edit_hpbw_deg );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.edit_SLL_dB );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.edit_XPL_dB );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.popup_pol_Rx );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.edit_sand_ratio );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.edit_clay_ratio );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.edit_rhob_gcm3 );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.pb_load_inputs );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.pb_save_inputs );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.pb_SCoBi );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.pb_exit );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.popup_ant_pat_Rx );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.popup_diel_model );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.pb_ant_pat_Rx_file );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.pb_dyn_inputs_file );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.pb_veg_inputs_file );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.edit_dyn_inputs_file );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.edit_ant_pat_Rx_file );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.edit_veg_inputs_file );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.popup_orientation_Rx );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.edit_th0_Rx );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.edit_ph0_Rx );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.edit_ant_pat_res_Rx );
...
global guiSCoBiMLManager
guiSCoBiMLManager.syncFromGUI( guiSCoBiMLManager.uiIDs.pb_ant_pat_Rx_GG_input );
