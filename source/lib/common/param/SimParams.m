classdef SimParams < handle
    ...
    properties (SetAccess = private, GetAccess = public)
        ...
        % Vegetation type can take the values listed in Constants.veg_methods
        % e.g. "Virtual" OR "Homogenous"
        veg_method_id
        
        % Can take the values defined for Constants.veg_vir_orientations
    ...
    methods
        ...
        function initialize(obj, sim_name, campaign, campaign_date, ...
            ...
            obj.plot = plot;
            obj.veg_method_id = veg_method_id;
            obj.veg_vir_orientation_id = veg_vir_orientation_id;
        ...
        function out = get.veg_method_id(obj)
            out = obj.veg_method_id;
        end
        
        function out = get.veg_vir_orientation_id(obj)
            out = obj.veg_vir_orientation_id;
        end
