classdef SimParams < handle
    ...
    properties (SetAccess = private, GetAccess = public)
        ...
        % Vegetation isRow can take two values 0 OR 1
        vegetation_isRow
    ...
    methods
        ...
        function initialize(obj, sim_name, campaign, campaign_date, ...
            ...
            obj.plot = plot;
            obj.vegetation_method = vegetation_method;
            obj.vegetation_isRow = vegetation_isRow;
        ...
        function out = get.vegetation_isRow(obj)
            out = obj.vegetation_isRow;
        end
