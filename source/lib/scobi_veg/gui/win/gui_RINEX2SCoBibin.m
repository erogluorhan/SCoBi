function varargout = gui_RINEX2SCoBibin(varargin)
% GUI_RINEX2GOGPSBIN M-file for gui_RINEX2SCoBibin.fig
...
%      applied to the GUI before gui_RINEX2SCoBibin_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to gui_RINEX2SCoBibin_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help gui_RINEX2SCoBibin
...
gui_State = struct('gui_Name', mfilename, ...
    ...
    'gui_OpeningFcn', @gui_RINEX2SCoBibin_OpeningFcn, ...
    'gui_OutputFcn',  @gui_RINEX2SCoBibin_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before gui_RINEX2SCoBibin is made visible.
function gui_RINEX2SCoBibin_OpeningFcn(hObject, eventdata, handles, varargin) %#ok<*INUSL>
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to gui_RINEX2SCoBibin (see VARARGIN)

% Choose default command line output for gui_RINEX2SCoBibin
...
function varargout = gui_RINEX2SCoBibin_OutputFcn(hObject, eventdata, handles)  %#ok<*STOUT,*INUSD>
...
RINEX2SCoBibin(filename_R_obs, filename_R_nav, filename_M_obs, filename_M_nav, filerootOUT, wait_dlg);

close(wait_dlg)

close(handles.RINEX2SCoBi_panel)
