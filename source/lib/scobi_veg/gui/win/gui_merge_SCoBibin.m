function varargout = gui_merge_SCoBibin(varargin)
% GUI_MERGE_GOGPSBIN M-file for gui_merge_SCoBibin.fig
...
%      applied to the GUI before gui_merge_SCoBibin_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to gui_merge_SCoBibin_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help gui_merge_SCoBibin
...
gui_State = struct('gui_Name', mfilename, ...
    ...
    'gui_OpeningFcn', @gui_merge_SCoBibin_OpeningFcn, ...
    'gui_OutputFcn',  @gui_merge_SCoBibin_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before gui_merge_SCoBibin is made visible.
function gui_merge_SCoBibin_OpeningFcn(hObject, eventdata, handles, varargin) %#ok<*INUSL>
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to gui_merge_SCoBibin (see VARARGIN)

% Choose default command line output for gui_merge_SCoBibin
...
function varargout = gui_merge_SCoBibin_OutputFcn(hObject, eventdata, handles)  %#ok<*STOUT,*INUSD>
...
SCoBibinMerge(filerootR, filerootM, filerootOUT, wait_dlg);
