...
function plotPower_forHomogenous_TH
...
minPow_dB = -233 + EIRP_choice_dB + G0r_choice_dB;
maxPow_dB = -183 + EIRP_choice_dB + G0r_choice_dB;        
axis([0 90 minPow_dB maxPow_dB + 5])
xlabel('\theta_s [\circ]')
...
text(10, -180, strcat( 'VSM=', num2str( VSM_cm3cm3 ), ' cm^3/cm^3' ))
text(10, -183, strcat( 'RMSH=', num2str( RMSH_cm ), ' cm' ))
text(10, -186, strcat('fzone = ', num2str(FZ_choice)))

subplot(1,2,2)
plot(th0_Tx_list_deg, Pvi_RR, '-^g', 'MarkerFaceColor', 'green', 'markersize', 5)
%text( 75, Pvi_RR(end), strcat( num2str( rowPhis(jj) ) ) )
legend('Specular-Bare', 'Specular-Bare (Ideal)', 'Specular-Vegetation', 'Specular-Veg. (Ideal)', 'Diffuse-Vegetation')
...
%%
fname1 = strcat('ReceivedPower(Homogenous)_vs_Th-', vegetation_stage, '-FZ_', num2str(FZ_choice), '-', pol_Tx, pol_Rx, '-PH_', num2str( ph0_Tx_deg ), '-VSM_', num2str( VSM_cm3cm3 ), '-RMSH_', num2str( RMSH_cm ) ) ;
