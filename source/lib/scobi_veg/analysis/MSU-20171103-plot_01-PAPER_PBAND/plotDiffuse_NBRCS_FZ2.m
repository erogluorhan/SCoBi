...
%     pols11 = 'XX' ;     pols12 = 'XY' ;
%     pols21 = 'YX' ;     pols22 = 'YY' ;
% elseif (pol_Tx == 'R') && (pol_Rx == 'R')
%     pols11 = 'RR' ;     pols12 = 'RL' ;
%     pols21 = 'LR' ;     pols22 = 'LL' ;
% elseif (pol_Tx == 'R') && (pol_Rx == 'X')
%     pols11 = 'RX' ;     pols12 = 'RY' ;
%     pols21 = 'LX' ;     pols22 = 'LY' ;
% elseif (pol_Tx == 'L') && (pol_Rx == 'L')
%     pols11 = 'LL' ;     pols12 = 'LR' ;
%     pols21 = 'RL' ;     pols22 = 'RR' ;
% elseif (pol_Tx == 'L') && (pol_Rx == 'X')
%     pols11 = 'LX' ;     pols12 = 'LY' ;
%     pols21 = 'RX' ;     pols22 = 'RY' ;
% end
% 
...
% % %%
% % fname1 = strcat('TH_', num2str(th0d), '_', pol_Tx, pol_Rx, '_SM_', num2str(tp(SM_choice))) ;
% % 
...
%%
fname1 = strcat('XTH2_', num2str(th0_Tx_deg), '-', pol_Tx, pol_Rx, '-VSM_', num2str( VSM_cm3cm3 ) );
...
%%
fname1 = strcat('XTH3_', num2str(th0_Tx_deg), '-', pol_Tx, pol_Rx, '-VSM_', num2str( VSM_cm3cm3 ) );
fname1 = strrep( fname1, '.', 'dot' );
...
%%
fname1 = strcat('XTH4_', num2str(th0_Tx_deg), '-', pol_Tx, pol_Rx, '-VSM_', num2str( VSM_cm3cm3 ) );
fname1 = strrep( fname1, '.', 'dot' );
