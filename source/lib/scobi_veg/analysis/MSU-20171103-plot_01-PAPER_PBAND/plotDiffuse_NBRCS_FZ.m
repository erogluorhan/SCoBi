...
%%
fname1 = strcat('TH_', num2str( th0_Tx_deg ), '-', pol_Tx, pol_Rx, '-VSM_', num2str( VSM_cm3cm3 )) ;
...
%% GET GLOBAL PARAMETERS
% Transmitter Parameters
th0_Tx_deg = TxParams.getInstance.th0_Tx_list_deg( ParamsManager.index_Th );
% Ground Parameters
VSM_cm3cm3 = DynParams.getInstance.VSM_list_cm3cm3( ParamsManager.index_VSM );


%%
fname1 = strcat('TH2_', num2str( th0_Tx_deg ), '-', pol_Tx, pol_Rx, '-VSM_', num2str( VSM_cm3cm3 ) ) ;
fname1 = strrep( fname1, '.', 'dot' );
