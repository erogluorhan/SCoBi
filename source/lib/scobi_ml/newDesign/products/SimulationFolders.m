...
%             vegetation_stage = VegParams.getInstance.vegetation_stage;
            ...
            obj.simulations = strcat( main_dir, '\sims\SCoBi-ML');
            
%             obj.veg_method = strcat( obj.simulations, '\', Constants.veg_methods{1, veg_method_id} );
%             
%             if veg_method_id == Constants.id_veg_hom
%                 
%                 obj.vegetation_plant = strcat( obj.veg_method, '\', vegetation_plant );
%             
%             elseif veg_method_id == Constants.id_veg_vir
%                 
%                 if veg_vir_orientation_id == Constants.id_veg_vir_row_crop
%                     
%                     obj.vegetation_plant = strcat( obj.veg_method, '-row', '\', vegetation_plant );
%                 
%                 elseif veg_vir_orientation_id == Constants.id_veg_vir_random_spread
%                     
%                     obj.vegetation_plant = strcat( obj.veg_method, '-rnd\', vegetation_plant );
%                 
%                 end
%                 
%             end
...
%             obj.campaign = strcat( obj.vegetation_stage, '\', campaign );
            obj.campaign = strcat( obj.simulations, '\', campaign );
...
%                 
%                 obj.sim_mode = strcat( obj.hr, '\', Constants.sim_modes{ Constants.id_snapshot } );
%             
%             elseif sim_mode_id == Constants.id_time_series
%                 
%                 obj.sim_mode = strcat( obj.hr, '\', Constants.sim_modes{ Constants.id_time_series } );
%                 
%             end
        end
        ...
        function initializeDynamicDirs(obj)
            ...
            obj.th0_deg = strcat(obj.hr, '\', th0d_folder) ;
...
%             obj.out_diffuse_NBRCS_tuple = strcat(obj.out_diffuse_NBRCS, '\VSM_', num2str( VSM_cm3cm3 ), '-RMSH_', num2str(RMSH_cm)) ; 
        ...
        function out = get.veg_method(obj)
            out = obj.veg_method;
        end
