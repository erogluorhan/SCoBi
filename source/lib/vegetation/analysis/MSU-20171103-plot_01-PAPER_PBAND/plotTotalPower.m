...
fname1 = strcat('sig_RR_FZ_', num2str(FZ_choice), '-', pol_Tx, pol_Rx, '-VSM_', num2str( VSM_cm3cm3 )) ;
...
%%
fname1 = strcat('RR_FZ_', num2str(FZ_choice), '-', pol_Tx, pol_Rx, '-VSM_', num2str( VSM_cm3cm3 )) ;
fname1 = strrep( fname1, '.', 'dot' );
...
%%
fname1 = strcat('FZ_', num2str(FZ_choice), '-', pol_Tx, pol_Rx, '-VSM_', num2str( VSM_cm3cm3 ) ) ;
fname1 = strrep( fname1, '.', 'dot' );
