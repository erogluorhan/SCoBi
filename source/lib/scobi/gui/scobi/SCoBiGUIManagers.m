...
%
%   Implements the management functionalities for the SCoBi GUI elements.
%   It should be inherited by the GUI handle classes.
%
%   See also gui_SCoBiMain_Manager, gui_SCoBi_Manager.
...
%   Version: 1.0.0
    ...
    properties(GetAccess = 'public', SetAccess = 'protected')
        ...
        uiPointers;          % Array n x 2 containing at the uiIDs index the handle of the object in the 
    ...
    methods
        ...
        function openAboutDialog(obj)
           ...
           %get display size
            ...
            txtDevelopers = uicontrol('Parent',d,...
                                 'Style','text',...
                                 'HorizontalAlignment', 'left', ...
                                 'Position',[20 335 480 25],...
                                 'String', 'Developers: Orhan Eroglu, Dylan R. Boyd, Mehmet Kurum');

            txtGNUGPL = uicontrol('Parent',d,...
                                 'Style','text',...
                                 'HorizontalAlignment', 'left', ...
                                 'Position',[20 290 480 25],...
                                 'String', 'This software is under the terms of GNU General Public License (GPL)');

            txtCopyright = uicontrol('Parent',d,...
                                 'Style','text',...
                                 'HorizontalAlignment', 'left', ...
                                 'Position',[20 245 480 25],...
                                 'String', 'Copyright © 2017-2018 Mehmet Kurum, Orhan Eroglu, Dylan R. Boyd');
            ...
            btnMsstate = uicontrol('Parent',d,...
                                  ...
                                  'String','',...
                                  'cdata',I2, ...
                                  'Callback', strcat('web(''', Constants.URL_MSSTATE, ''', ''-browser'')'));
                                                     
            txtReferences = uicontrol('Parent',d,...
                                      'Style','text',...
                                      'HorizontalAlignment', 'left', ...
                                      'Position',[20 145 480 20],...
                                      'String', 'References:');
            ...
            txtReference2 = uicontrol('Parent',d,...
                                 ...
                                 'String', '[2] O. Eroglu, D. R. Boyd, and M. Kurum, “SCoBi: A Free, Open-Source, SoOp Coherent Bistatic Scattering Simulator Framework," IEEE Geosci. and Remote Sensing Mag., Review.');
        ...
        function openDocumentsDialog(obj)
           ...
           % Create a dialog and display the URL   
            ...
            %calculate the center of the display
            position = [0, 0, 300, 240];
            position(1) = round( ( screenSize(3) - position(3) ) / 2 );
            position(2) = round( ( screenSize(4) - position(4) ) / 2 );

            d = dialog('Position', position, 'Name', 'SCoBi Documents');

            btnQuickStart = uicontrol('Parent',d,...
               'Position',[50 200 200 25],...
               'String','SCoBi Quick Start Guide',...
               'Callback', strcat('web(''', Constants.URL_SCOBI_QUICK_START_GUIDE, ''', ''-browser'')'));
           
            btnTutorialVideos = uicontrol('Parent',d,...
               'Position',[50 170 200 25],...
               'String','SCoBi Tutorial Videos',...
               'Callback', strcat('web(''', Constants.URL_SCOBI_TUTORIAL_VIDEOS, ''', ''-browser'')'));
           
            btnPresentation = uicontrol('Parent',d,...
               'Position',[50 140 200 25],...
               'String','SCoBi Presentation',...
               'Callback', strcat('web(''', Constants.URL_SCOBI_PRESENTATION, ''', ''-browser'')'));
