...
fig_out_pathname = strcat( dir_fig_diffuse_P1_vsFZ, '\TH_', num2str( th0_Tx_deg ) );
...
fname = strcat('FZ-ReceivedPower_IND_dB', '-TH_', num2str( th0_Tx_deg ), '-PH_', num2str( ph0_Tx_deg ), '-RMSH_', num2str( RMSH_cm ) );
...
fname = strcat('FZ-ReceivedPower_ALL_dB', '-TH_', num2str( th0_Tx_deg ), '-PH_', num2str( ph0_Tx_deg ), '-RMSH_', num2str( RMSH_cm ) );
fname = strrep( fname, '.', 'dot' );
saveas(gcf, strcat(fig_out_pathname, '\',fname), 'tiff')
close
