...
ymin = ymin1 - 10 ;
ymax = ymin1 + P_range ;
plot(th0_Tx_list_deg, squeeze(NBRCS_dB(1, 1, :)), '-or')
hold
plot(th0_Tx_list_deg, squeeze(NBRCS_dB(1, 2, :)), ':or')
plot(th0_Tx_list_deg, squeeze(NBRCS_dB(2, 1, :)), '-sb')
plot(th0_Tx_list_deg, squeeze(NBRCS_dB(2, 2, :)), ':sb')
...
fname = strcat('TH-NBRCS_ALL_dB', '-PH_', num2str( ph0_Tx_deg ), '-VSM_', num2str( VSM_cm3cm3 ), '-RMSH_', num2str( RMSH_cm ) );
...
%
subplot(2, 2, 1)
plot(th0_Tx_list_deg, squeeze(NBRCS1_dB(1, 1, :)), '-or')
hold
plot(th0_Tx_list_deg, squeeze(NBRCS1_dB(1, 2, :)), ':or')
plot(th0_Tx_list_deg, squeeze(NBRCS1_dB(2, 1, :)), '-sb')
plot(th0_Tx_list_deg, squeeze(NBRCS1_dB(2, 2, :)), ':sb')
...
subplot(2, 2, 2)
plot(th0_Tx_list_deg, squeeze(NBRCS2_dB(1, 1, :)), '-or')
hold
plot(th0_Tx_list_deg, squeeze(NBRCS2_dB(1, 2, :)), ':or')
plot(th0_Tx_list_deg, squeeze(NBRCS2_dB(2, 1, :)), '-sb')
plot(th0_Tx_list_deg, squeeze(NBRCS2_dB(2, 2, :)), ':sb')
...
ymax = ymin3 + P_range ;
subplot(2, 2, 3)
plot(th0_Tx_list_deg, squeeze(NBRCS3_dB(1, 1, :)), '-or')
hold
plot(th0_Tx_list_deg, squeeze(NBRCS3_dB(1, 2, :)), ':or')
plot(th0_Tx_list_deg, squeeze(NBRCS3_dB(2, 1, :)), '-sb')
plot(th0_Tx_list_deg, squeeze(NBRCS3_dB(2, 2, :)), ':sb')
...
ymax = ymin4 + P_range ;
subplot(2, 2, 4)
plot(th0_Tx_list_deg, squeeze(NBRCS4_dB(1, 1, :)), '-or')
hold
plot(th0_Tx_list_deg, squeeze(NBRCS4_dB(1, 2, :)), ':or')
plot(th0_Tx_list_deg, squeeze(NBRCS4_dB(2, 1, :)), '-sb')
plot(th0_Tx_list_deg, squeeze(NBRCS4_dB(2, 2, :)), ':sb')
...
%%
fname = strcat('TH-NBRCS_IND_dB', '-PH_', num2str( ph0_Tx_deg ), '-VSM_', num2str( VSM_cm3cm3 ), '-RMSH_', num2str( RMSH_cm ) );
fname = strrep( fname, '.', 'dot' );
