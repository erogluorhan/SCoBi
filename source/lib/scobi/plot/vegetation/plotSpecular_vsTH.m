        ...
        for vv = 1 : num_VSM
            ...
            for rr = 1 : num_RMSH
                ...
                %% Received Power in dB
                    ...
                    if (pol_Tx == Constants.polarizations{Constants.id_pol_R}) ...
                    ...
                    elseif (pol_Tx == Constants.polarizations{Constants.id_pol_X} ) ...
                        && (pol_Rx == Constants.polarizations{Constants.id_pol_X})
                    ...
                    fname = strcat('ReceivedPower_dB', '-PH_', num2str( ph0_Tx_list_deg(pp) ), '-VSM_', num2str( VSM_list_cm3cm3(vv) ), '-RMSH_', num2str( RMSH_list_cm(rr) ) );
                ...
                fname = strcat('Reflectivity_dB', '-PH_', num2str( ph0_Tx_list_deg(pp) ), '-VSM_', num2str( VSM_list_cm3cm3(vv) ), '-RMSH_', num2str( RMSH_list_cm(rr) ) );
                fname = strrep( fname, '.', 'dot' );
                saveas(gcf, strcat(dir_fig_specular_P_vsTH, '\',fname), 'tiff')
                close
