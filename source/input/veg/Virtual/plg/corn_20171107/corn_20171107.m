...
%         end
        ...
        function [dielStalk_RE_mu, dielStalk_RE_sigma, ...
            ...
            dielStalk_RE_mu = obj.pdfStemDielRe.mu;
            dielStalk_RE_sigma = obj.pdfStemDielRe.sigma;  
            dielStalk_IM_mu = obj.pdfStemDielIm.mu;
            dielStalk_IM_sigma = obj.pdfStemDielIm.sigma;   
            
            dielLeaf_RE_mu = obj.pdfLeafDielRe.mu;
            dielLeaf_RE_sigma = obj.pdfLeafDielRe.sigma;   
            dielLeaf_IM_mu = obj.pdfLeafDielIm.mu;
            dielLeaf_IM_sigma = obj.pdfLeafDielIm.sigma; 
            
            dielCob_RE_mu = obj.pdfCobDielRe.mu;
            dielCob_RE_sigma = obj.pdfCobDielRe.sigma;
            dielCob_IM_mu = obj.pdfCobDielIm.mu;
            dielCob_IM_sigma = obj.pdfCobDielIm.sigma;
